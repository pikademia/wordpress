...
if( empty( $_GET ) ){
	...
	foreach( $_GET as $key => $val ){
		if(
			...
			in_array( substr( $key, strlen( $table_id ) + 1  ), apply_filters( 'wcpt_clear_filter_skip_variables', array( 'availability', 'orderby', 'order', 'paged', 'device', 'sc_attrs', 'results_per_page', 'filtered', 'from_shop' ) ) ) ||
			(
